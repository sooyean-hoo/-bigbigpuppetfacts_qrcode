...
public class Pdf417lib {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            java.io.PrintWriter jjpr = new java.io.PrintWriter(new java.io.FileOutputStream( (args[0] + ".json" )  ));

            //Valente Modded -Start
            jjpr.printf("{ \"bitColumns\" : %d ",pd.getBitColumns() );
            jjpr.printf(", \"OutBits\"  : [  %d ", out[0]);
